...
<nav class="navbar navbar-light navbar-toggleable-md py-0">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav ml-auto">
        ...
        <a class="nav-item nav-link py-0" href="http://mystudycards.com/contact.php">Upload StudyCards</a>
  </div>
</div>
</nav>
...
<div class="container container-fluid indexContainer">
  ...
  <div class="row">
    ...
    <div class="col-md-auto">
        <div class="loading_offset" id="loading_offset"></div>
  ...
  <div class="row searchRow">
    <div class="col-3">
  	 ...
  	 <div class="col-md-auto">
        <form action="checkUniversity.php" method="post" class="searchboxmargin">
...
$(document).ready(function(){
  ...
  $(document).ajaxStart(function(){
    ...
    $('#loading_offset').css("visibility", "hidden");
   });
